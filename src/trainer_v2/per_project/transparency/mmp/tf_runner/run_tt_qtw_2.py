...
from trainer_v2.per_project.transparency.mmp.tt_model.tt1 import TranslationTableQTW2
...
class TranslationTable2WBert(ModelV2IF):
    ...
    def build_model(self, run_config):
        ...
        print(bert_params)
        self.inner_model = TranslationTableQTW2(bert_params, self.input_shape)
