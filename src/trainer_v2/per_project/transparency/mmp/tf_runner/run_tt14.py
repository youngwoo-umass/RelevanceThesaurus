...
from trainer_v2.per_project.transparency.mmp.tt_model.tt1 import ScoringLayer2, ScoringLayerSigmoidCap, ScoringLayer4, \
    ScoringLayer5
from trainer_v2.per_project.transparency.mmp.tt_model.tt_vectored import TTVectorBasedTrainNetworkTrainable
...
class TranslationTableVector(ModelV2IF):
    def __init__(self, input_shape: InputShapeConfigTT):
        self.inner_model: Optional[TTVectorBasedTrainNetworkTrainable] = None
    ...
    def build_model(self, run_config):
        ...
        self.inner_model = TTVectorBasedTrainNetworkTrainable(
            bert_params,
            self.input_shape,
            pairwise_hinge,
