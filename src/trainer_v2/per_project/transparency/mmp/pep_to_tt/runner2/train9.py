# Do not use regularization loss
import logging
import sys
...
from trainer_v2.per_project.transparency.mmp.pep_to_tt.dataset_builder import read_pep_tt_dataset2
from trainer_v2.per_project.transparency.mmp.pep_to_tt.pep_tt_modeling import PEP_TT_ModelConfig, \
    PEP_TT_Model_Single3
...
def main(args):
    ...
    task_model = PEP_TT_Model_Single3(model_config)
    seq_len = model_config.max_seq_length

    def build_dataset(input_files, is_for_training):
        return read_pep_tt_dataset2(
