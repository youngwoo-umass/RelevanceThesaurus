...
class PredictionConfig256_1(TermPairPredictionConfig):
    max_seq_length = 256
    num_classes = 1
...
def main():
    table_path = "output/mmp/dev1000_d_terms_pep_table_head.tsv"
    ...
    config = PredictionConfig256_1()
    log_path = f"output/mmp/tables/d1K_{config.max_seq_length}_{config.n_mask_postpad}.tsv"
    predict_with_fixed_context_model_and_save(
        config,
