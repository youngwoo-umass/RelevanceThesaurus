...
from trainer_v2.per_project.transparency.mmp.pep.inf_helper import get_term_pair_predictor_compress_mask
...
def main():
    ...
    for q_term_i in range(st , ed):
        ...
        predict_term_pairs_fn = get_term_pair_predictor_compress_mask(model_path)
