...
from transformers import BertConfig, shape_list
from transformers.modeling_tf_outputs import TFBaseModelOutputWithPastAndCrossAttentions, \
    TFBaseModelOutputWithPoolingAndCrossAttentions
from transformers.modeling_tf_utils import get_initializer, TFSequenceClassificationLoss, unpack_inputs, \
    keras_serializable, TFModelInputType
